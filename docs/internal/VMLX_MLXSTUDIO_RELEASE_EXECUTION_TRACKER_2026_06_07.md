...
| Gemma local QAT/native MXFP4 inventory gate | `build/current-gemma-qat-native-mxfp4-local-inventory-20260609.json` | `status=open`, `count=11`; the no-heavy gate reports missing required rows `gemma3n_e2b_qat_native4` and `gemma3n_e4b_qat_native4`, and open present rows `gemma4_12b_native_mxfp4`, `gemma4_26b_vl`, and `gemma4_31v_or_31b_vl`. Local normal roots currently contain Gemma4 12B JANG/MXFP variants, Gemma4 26B JANG_4M CRACK, and Gemma4 31B JANG_4M-MTP. All present Gemma4 config rows advertise media, so audio/video/VL must either pass live or be capability-gated honestly per bundle. |
