...
- Gemma 26B JANG4M audio, installed-app parity, public tunnel SSE, and default
  4k video behavior.
...
- Dev-app image/VL is red by the same honest text-only runtime guard as the
  installed app. Do not claim MiMo JANGTQ_2 media support from preserved media
  weights.
