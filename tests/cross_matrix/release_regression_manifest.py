...
CURRENT_REGRESSION_SUITE_ARTIFACT = (
    "build/current-regression-suite-after-bundled-refresh-20260606.json"
)
...
_ROWS: list[dict[str, Any]] = [
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_noheavy_api_cache_contract.py --out build/current-noheavy-api-cache-contract-after-mimo-modality-truth-20260606.json",
        ],
        "artifacts": [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_max_output_context_contract.py --out build/current-max-output-context-contract-after-mimo-modality-truth-20260606.json",
        ],
        "artifacts": [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_model_artifact_format_contract.py --out build/current-model-artifact-format-contract-after-mimo-modality-truth-20260606.json",
        ],
        "artifacts": [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_model_family_detection_contract.py --out build/current-model-family-detection-contract-after-mimo-modality-truth-20260606.json",
        ],
        "artifacts": [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_packaged_integrity_contract.py --out build/current-packaged-integrity-contract-after-bundled-refresh-20260606.json",
        ...
        "artifacts": [
            "build/current-objective-proof-after-bundled-refresh-20260606.json",
            "build/current-packaged-integrity-contract-after-bundled-refresh-20260606.json",
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/summarize_objective_proof.py --out build/current-objective-proof-after-bundled-refresh-20260606.json",
    ...
    },
    {
        ...
        "commands": [
            ...
            ".venv/bin/python tests/cross_matrix/run_issue179_minimax_k_root_cause_audit.py --out build/current-issue179-minimax-k-root-cause-audit-after-public-v1556-scan-20260606.json",
