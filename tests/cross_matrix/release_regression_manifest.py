...
CURRENT_POST_BUDGET_EDGE_ARTIFACTS = {
    ...
    "api-chat-responses-anthropic-ollama-parity": "build/current-api-surface-contract-20260601-wrapped-epipe-refresh.json",
    ...
    "packaged-release-integrity": "build/current-packaged-integrity-contract-20260601-after-adhoc-reseal.json",
...
CURRENT_REAL_UI_DSV4_MEMORY_PREFLIGHT_ARTIFACT = (
    "build/current-real-ui-dsv4-memory-preflight-20260601-post-wrapped-epipe.json"
)
...
CURRENT_DSV4_SOURCE_MEMORY_PREFLIGHT_ARTIFACT = (
    "build/current-dsv4-route-mode-code-exactness-memory-preflight-20260601-post-wrapped-epipe.json"
)
...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_api_surface_contract.py --out build/current-api-surface-contract-20260601-wrapped-epipe-refresh.json",
        ],
        "artifacts": [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/run_packaged_integrity_contract.py --out build/current-packaged-integrity-contract-20260601-after-adhoc-reseal.json",
