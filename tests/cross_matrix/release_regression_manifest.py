...
CURRENT_POST_BUDGET_EDGE_ARTIFACTS = {
    "noheavy-api-cache-endpoint-runtime": "build/current-noheavy-api-cache-contract-after-dsv4-real-ui-valid-preflight-20260611.json",
...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/summarize_objective_proof.py --out build/current-objective-proof-after-n2-strict-loopback-consumed-20260611.json",
    ...
    },
    {
        ...
        "commands": [
            ...
            ".venv/bin/python tests/cross_matrix/run_issue179_responses_cancel_probe.py --model /Users/eric/models/dealign.ai/MiniMax-M2.7-JANGTQ_K-CRACK --python panel/bundled-python/python/bin/python3.12 --served-model models/MiniMax-M2.7-JANGTQ_K --out build/current-issue179-minimax-k-responses-cancel-probe-fullk-local-skip-preflight-20260611.json --skip-memory-preflight --load-timeout 420 --request-timeout 180 --stream-seconds 8 --cancel-delay 0.25 --max-lines-after-cancel 20",
            ...
            ".venv/bin/python tests/cross_matrix/run_issue179_minimax_k_root_cause_audit.py --out build/current-issue179-minimax-k-root-cause-audit-after-fullk-local-cancel-proof-20260611.json",
