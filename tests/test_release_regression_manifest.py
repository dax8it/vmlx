...
def test_release_regression_manifest_tracks_packaged_integrity_with_runner_artifact():
    ...
    assert "current-objective-proof-after-n2-jangtq2-l2-live-proof-20260609.json" in joined
...
def test_release_regression_manifest_tracks_current_updater_and_i18n_rechecks():
    ...
    assert (
        "current-objective-proof-after-n2-jangtq2-l2-live-proof-20260609.json"
        in ling_joined
    )
