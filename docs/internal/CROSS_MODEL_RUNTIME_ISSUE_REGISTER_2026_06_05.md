...
- MiniMax #179 public v1.5.56 pointer refresh, 2026-06-06: release-manifest/current-suite/public-issue/boundary defaults now point at `build/current-issue179-minimax-k-root-cause-audit-after-public-v1556-scan-20260606.json`, `build/current-issue175-179-release-boundary-audit-after-public-v1556-scan-20260606.json`, and `build/current-public-app-issue-audit-after-public-v1556-scan-20260606.json`. Focused `issue179`/public issue regression tests passed (`39 passed`). The release blocker remains open for missing reporter-side installed hash/model/session/cancel lifecycle parity; do not classify it as current public/local route drift.
