...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ...
            ".venv/bin/python tests/cross_matrix/run_issue175_179_release_boundary_audit.py --out build/current-issue175-179-release-boundary-audit-after-minimax-live-refresh-20260606.json",
            ...
            ".venv/bin/python tests/cross_matrix/run_issue179_minimax_k_root_cause_audit.py --out build/current-issue179-minimax-k-root-cause-audit-after-live-refresh-20260606.json",
