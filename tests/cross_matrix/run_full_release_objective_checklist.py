...
DEFAULT_OUT = Path(
    "build/current-full-release-objective-checklist-after-current-mimo-text-speed-boundary-20260609.json"
)

MIMO_AUDIT = Path(
    "build/current-mimo-v2-jang2l-current-audit-after-current-text-speed-boundary-20260609.json"
)
